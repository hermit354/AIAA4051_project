...
GPU_ID="${GPU_ID:-5}"
DATA_ROOT="${DATA_ROOT:-${PROJECT_ROOT}/data/generated/phase2_size_generalization/stepwise_policy_distance}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${PROJECT_ROOT}/outputs/phase2_size_generalization/stepwise_policy_distance/flan-t5-base}"
