...
SEED_OUTPUT_ROOT="${SEED_OUTPUT_ROOT:-${PROJECT_ROOT}/outputs/phase2_size_generalization/stepwise_policy/flan-t5-base}"
DAGGER_DATA_ROOT="${DAGGER_DATA_ROOT:-${PROJECT_ROOT}/data/generated/phase2_size_generalization/stepwise_policy_dagger}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${PROJECT_ROOT}/outputs/phase2_size_generalization/stepwise_policy_dagger/flan-t5-base}"
...
if [ ! -d "${SEED_OUTPUT_ROOT}/best" ]; then
  echo "Missing seed checkpoint: ${SEED_OUTPUT_ROOT}/best" >&2
  exit 1
fi
...
if [ ! -f "${DAGGER_DATA_ROOT}/manifest.json" ]; then
